     ...
     public List<TrangChu> getAllBs() {
        ...
        try (Connection con = DBConnect.getConnect();
            ...
            while (rs.next()) {
                ...
                bacsiDTO.setId(rs.getLong(1));
                bacsiDTO.setTenBacSi(rs.getString(2));
                bacsiDTO.setSoNamKinhNghiem(rs.getInt(3));
                bacsiDTO.setChuyenKhoa(rs.getString(4));
                bacsiDTO.setSdt(rs.getString(5));
                bacsiDTO.setTrangThai(rs.getString(6));
