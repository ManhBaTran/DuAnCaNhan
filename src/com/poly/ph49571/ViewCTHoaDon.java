...
private void loadtb() throws SQLException {
    ...
    private void initComponents() {
        ...
        if (tbtable.getColumnModel().getColumnCount() > 0) {
            tbtable.getColumnModel().getColumn(0).setMaxWidth(50);
            tbtable.getColumnModel().getColumn(1).setMaxWidth(50);
            tbtable.getColumnModel().getColumn(2).setMaxWidth(50);
        }
    ...
    private void cbbtrangthaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbbtrangthaiActionPerformed
        try {
            ...
            if (trangthai.equals("Đã thanh toán")) {
                ...
                trangthaivalue = "Chưa thanh toán";
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int index = tbtable.getSelectedRow();
            if (index >= 0 && index < globalList .size()) { 
                ModeChiTietHoaDon selectedDetail = globalList .get(index);
                ...
                detailModel.addRow(new Object[] {
                    ...
                    selectedDetail.getThanhtienchitiet(),
                    selectedDetail.getNgaythanhtoan(),
                    selectedDetail.getTrangThaiText(),
