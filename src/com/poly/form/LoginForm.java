...
public class LoginForm extends javax.swing.JPanel {
        ...
        loginLayout.setHorizontalGroup(
            ...
            .addGroup(loginLayout.createSequentialGroup()
                ...
                .addGroup(loginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(loginLayout.createSequentialGroup()
                        .addComponent(cmdLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    // Thực hiện xác thực tên người dùng và mật khẩu tại đây
    if (validateLogin(username, password)) {
        Application.login(); // Gọi phương thức login() sau khi xác thực thành công
    } else {
        JOptionPane.showMessageDialog(this, "Tên người dùng hoặc mật khẩu không đúng.", "Lỗi đăng nhập", JOptionPane.ERROR_MESSAGE);
    }
}

private boolean validateLogin(String username, String password) {
    // Giả sử bạn có phương thức validate login thực sự ở đây
    return "1".equals(username) && "1".equals(password); // Ví dụ kiểm tra đơn giản
