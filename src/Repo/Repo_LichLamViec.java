...
public class Repo_LichLamViec {
    ...
    private String sql;
        ...
        public ArrayList<Model_LichLamViec>tim(String idTim){
            sql="select ID,BacSiID,Ngay,ThoiGianBatDau,ThoiGianKetThuc,GhiChu,CaLamViec,TrangThai,NgayTao from LichLamViec where Ngay like ?";
        ...
        public ArrayList<Model_LichLamViec> timCa(String idTim){
            sql="select ID,BacSiID,Ngay,ThoiGianBatDau,ThoiGianKetThuc,GhiChu,CaLamViec,TrangThai,NgayTao from LichLamViec where CaLamViec like ?";
            ArrayList<Model_LichLamViec> list_LLViec=new ArrayList<>();
            try {
                con=DBConnect.getConnect();
                ps=con.prepareStatement(sql);
