...
public class HoaDon_Jframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_them.setForeground(new java.awt.Color(60, 63, 65));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/search2.png"))); // NOI18N
        ...
        if (tbl_HD.getColumnModel().getColumnCount() > 0) {
            tbl_HD.getColumnModel().getColumn(0).setHeaderValue("ID hóa đơn");
            tbl_HD.getColumnModel().getColumn(1).setHeaderValue("Mã bệnh nhân");
            tbl_HD.getColumnModel().getColumn(2).setHeaderValue("Mã bác sĩ");
            tbl_HD.getColumnModel().getColumn(3).setHeaderValue("Mã lễ tân");
            tbl_HD.getColumnModel().getColumn(4).setHeaderValue("Tên khách hàng");
            tbl_HD.getColumnModel().getColumn(5).setHeaderValue("Địa chỉ");
            tbl_HD.getColumnModel().getColumn(6).setHeaderValue("Số điện thoại");
            tbl_HD.getColumnModel().getColumn(7).setHeaderValue("Email");
            tbl_HD.getColumnModel().getColumn(8).setHeaderValue("Phương thức thanh toán");
            tbl_HD.getColumnModel().getColumn(9).setHeaderValue("Tiền khách đưa");
            tbl_HD.getColumnModel().getColumn(10).setHeaderValue("Tiền thừa");
            tbl_HD.getColumnModel().getColumn(11).setHeaderValue("Thành tiền");
            tbl_HD.getColumnModel().getColumn(12).setHeaderValue("Ngày tạo");
            tbl_HD.getColumnModel().getColumn(13).setHeaderValue("Ngày thanh toán");
            tbl_HD.getColumnModel().getColumn(14).setHeaderValue("Trạng thái");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoaDon_Jframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HoaDon_Jframe().setVisible(true);
            }
        });
    }
