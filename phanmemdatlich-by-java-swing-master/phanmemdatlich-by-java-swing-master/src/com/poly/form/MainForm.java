...
import com.poly.view.From_BenhNhan;
...
//
                    ...
                    Application.showForm(new BenhNhan1());
                }else if (index == 5) {
                    ...
                    Application.showForm(new  HoaDon_Jpanel());
                }
                
                
                // tương ứng với menu (Quản lý sản phẩm)
