...
public class LichLamViec_Jpanel extends javax.swing.JPanel {
    ...
    private void tbl_LLVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_LLVMouseClicked
        // TODO add your handling code here:
        i=tbl_LLV.getSelectedRow();
        txt_id.setText(tbl_LLV.getValueAt(i,0).toString());
        cbo_bacSiID.setSelectedItem(tbl_LLV.getValueAt(i,1).toString());
        txt_ngay.setText(tbl_LLV.getValueAt(i,2).toString());
        txt_batDau.setText(tbl_LLV.getValueAt(i,3).toString());
        txt_ketThuc.setText(tbl_LLV.getValueAt(i,4).toString());
        txt_ghiChu.setText(tbl_LLV.getValueAt(i,5).toString());
        txt_ca.setText(tbl_LLV.getValueAt(i,6).toString());
        if(tbl_LLV.getValueAt(i,7).toString().equalsIgnoreCase("Hoạt động")){
            rdo_onl.setSelected(true);
        }else{
            rdo_off.setSelected(true);
        }
        txt_ngayTao.setText(tbl_LLV.getValueAt(i,8).toString());
